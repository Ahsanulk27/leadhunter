/**
 * Multi-Location Consumer Lead Scraper for cleaning services
 * Generates consumer leads across multiple locations
 */
...
function generateConsumerLeads(count, location) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    leads.push({
      ...
      leadScore,
      isHotLead,
      notes: generateLeadNotes(name, propertyType, need, city)
    });
  }
 ...
 */
function generateLeadNotes(name, propertyType, need, city) {
