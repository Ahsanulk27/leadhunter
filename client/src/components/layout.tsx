              ...
              <button
                ...
                onClick={() => {
                  toast({
                    title: "Settings",
                    description:
                      "Settings functionality is not implemented in this demo.",
                  });
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  toast({
                    title: "User Profile",
                    description:
                      "User profile functionality is not implemented in this demo.",
                  });
                }}
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-sm text-gray-500">
                &copy; 2023 LeadHunter. All rights reserved.
              </p>
            </div>
            <div className="flex items-center space-x-4">
