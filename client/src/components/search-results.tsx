    ...
    <Card className="mb-6">
      <CardContent className="p-6">
        ...
        {isLoading ? (
          ...
          <>
            {/* Show sample data notification if applicable */}
            {contacts.length > 0 && contacts[0].source === 'sample-data' && (
              <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-md p-3 mb-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-amber-800">Sample Data Notice</h3>
                    <div className="mt-1 text-sm text-amber-700">
                      <p>This search is displaying sample data because external data sources detected anti-bot measures. This is common during development and testing. In a production environment, this would show real business data.</p>
                    </div>
                  </div>
                </div>
              </div>
