          ...
          <Tabs defaultValue="api" className="w-full">
            ...
            <TabsContent value="api" className="mt-6">
              <div className="space-y-6">
                ...
                <p className="text-sm text-gray-500">
                  ...
                  Google Places API to find business data, with a default quota
                  of 1,000 requests per day.
                </p>
            ...
            <TabsContent value="general" className="mt-6">
              <div className="space-y-6">
                ...
                <p className="text-gray-500">
                  This feature is coming soon. General settings will allow you
                  to customize the application appearance and behavior.
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="data" className="mt-6">
              <div className="space-y-6">
                ...
                <p className="text-gray-500">
                  This feature is coming soon. Data settings will allow you to
                  control how your search data is stored and manage your search
                  history.
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="about" className="mt-6">
              <div className="space-y-6">
                ...
                <p className="text-gray-500">
                  ...
                  streamline contact discovery across multiple industries, with
